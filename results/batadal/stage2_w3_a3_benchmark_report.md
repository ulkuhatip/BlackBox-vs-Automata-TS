...
gaussian_noise 0.7890 0.7890 0.7890 0.0000
      original 0.7998 0.7998 0.7998 0.0000
        unseen 0.6571 0.6571 0.6571 0.0000

### AUTOMATA_F1

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.0928 0.0928 0.0928 0.0000
      original 0.0973 0.0973 0.0973 0.0000
        unseen 0.0833 0.0833 0.0833 0.0000

### AUTOMATA_PRECISION

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.0570 0.0570 0.0570 0.0000
      original 0.0604 0.0604 0.0604 0.0000
        unseen 0.0471 0.0471 0.0471 0.0000

### AUTOMATA_RECALL

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.2500 0.2500 0.2500 0.0000
      original 0.2500 0.2500 0.2500 0.0000
        unseen 0.3611 0.3611 0.3611 0.0000
