...
gaussian_noise 0.7230 0.7230 0.7230 0.0000
      original 0.7362 0.7362 0.7362 0.0000
        unseen 0.5995 0.5995 0.5995 0.0000

### AUTOMATA_F1

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.0941 0.0941 0.0941 0.0000
      original 0.0909 0.0909 0.0909 0.0000
        unseen 0.0874 0.0874 0.0874 0.0000

### AUTOMATA_PRECISION

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.0548 0.0548 0.0548 0.0000
      original 0.0534 0.0534 0.0534 0.0000
        unseen 0.0485 0.0485 0.0485 0.0000

### AUTOMATA_RECALL

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.3333 0.3333 0.3333 0.0000
      original 0.3056 0.3056 0.3056 0.0000
        unseen 0.4444 0.4444 0.4444 0.0000
