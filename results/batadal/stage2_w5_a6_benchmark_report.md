...
gaussian_noise 0.6130 0.6130 0.6130 0.0000
      original 0.6731 0.6731 0.6731 0.0000
        unseen 0.5216 0.5216 0.5216 0.0000

### AUTOMATA_F1

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.1006 0.1006 0.1006 0.0000
      original 0.1338 0.1338 0.1338 0.0000
        unseen 0.1076 0.1076 0.1076 0.0000

### AUTOMATA_PRECISION

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.0559 0.0559 0.0559 0.0000
      original 0.0755 0.0755 0.0755 0.0000
        unseen 0.0585 0.0585 0.0585 0.0000

### AUTOMATA_RECALL

      Scenario   Mean    Min    Max  Range
gaussian_noise 0.5000 0.5000 0.5000 0.0000
